...
20/08/29 17:04 按键映射关系，对应的按键都具有一个code称的别名，通过这个别名可以进行显示正在按的内容，我真是太睿智了。
待会做
...
20/08/29 22：24 XBoard画板的存在

https://github.com/OXOYO/X-WebDesktop-Vue

20/08/29 22: 48 发现一个有意思的开源项目

应用商店性网站？所以主流，插件，如何插入那个网站？

20/08/29 23:06 去看看 vs code源码，想想如何去实现插件商店

20/08/30 14:57 昨天想了很多，关于核心功能，笔记,whiteboard

想一想，第一版需要做的功能是什么？

核心编辑和显示功能，共享？想做的开放接口的目的是什么？数据录入，和快捷键接轨吗？
...
17：49 我应该建立一个基础base，然后通过动态添加元素，进行控制界面的内容的显示。

所以，我store只要acitons，和state进行保存数据，动态组件进行控制界面显示的内容。
