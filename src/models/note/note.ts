 ...
 * @LastEditors: xion
 * @LastEditTime: 2020-08-31 21:26:02
...
// 10个属性
export abstract class NoteData<V,T,S,C> extends BaseData<V>{
    category: C;
    created: number;
    hash: string;
    keys: string[];
...
export class Note<V=any, T=NoteType, S=NoteStatus, C=NoteCategory> extends NoteData<V,T,S,C>{
...
export class Comment extends Note<any, CommentType>{
    public constructor(note: any){
        super(note)
